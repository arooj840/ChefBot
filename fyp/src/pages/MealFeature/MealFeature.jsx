...
const MealFeature = () => {
  ...
  // ✅ FIXED: Routes updated to match App.js (/meal-calender)
  const goToCalendar = () => {
    ...
    // ✅ FIXED: /calendar → /meal-calender (App.js se match)
    if (planningMode === 'custom') {
      navigate('/meal-calender?mode=custom');
    } else if (planningMode === 'pantry') {
      navigate('/meal-calender?mode=pantry');
    }
  };
            ...
            <div className="mp-slide">
              <div className="mp-slide-content">
                ...
                <div className="mp-family-size-guide">
                  <div className="mp-size-guide-item clickable" onClick={() => handleFamilySizeSelect('1-2')}>
                    <span className="mp-guide-number">1-2</span>
                    <span className="mp-guide-text">Single or Couple</span>
                  </div>
                  <div className="mp-size-guide-item clickable" onClick={() => handleFamilySizeSelect('3-4')}>
                    <span className="mp-guide-number">3-4</span>
                    <span className="mp-guide-text">Small Family</span>
                  </div>
                  <div className="mp-size-guide-item clickable" onClick={() => handleFamilySizeSelect('5-7')}>
                    <span className="mp-guide-number">5-7</span>
                    <span className="mp-guide-text">Medium Family</span>
                  </div>
                  <div className="mp-size-guide-item clickable" onClick={() => handleFamilySizeSelect('8+')}>
            ...
            <div className="mp-slide">
              <div className="mp-slide-content">
                ...
                {budget && (
                  <div className="mp-selection-indicator">
                    Selected: <strong>
                      {budget === 'economy' ? 'Economy Budget' : 
                       budget === 'standard' ? 'Standard Budget' : 
                       budget === 'premium' ? 'Premium Budget' : 'Deluxe Budget'}
                    </strong>
                  </div>
                )}
            ...
            <div className="mp-slide">
              <div className="mp-slide-content">
                ...
                <div className="mp-planning-mode-grid">
                  {/* Option 1: Plan from Pantry */}
                  <div
                    className={`mp-planning-mode-card ${planningMode === 'pantry' ? 'selected' : ''}`}
                    onClick={() => handlePlanningModeSelect('pantry')}
                  >
                    <div className="mp-mode-number">1</div>
                    <div className="mp-mode-icon">🛒</div>
                    <h3 className="mp-mode-heading">Plan from My Pantry</h3>
                    <p className="mp-mode-text">
                      Generate meals using ingredients already available in your pantry
                      {pantryItems.length > 0 ? ` (${pantryItems.length} items available)` : ' (pantry empty)'}
                    </p>
                  </div>
                ...
                {planningMode && (
                  <div className="mp-selection-indicator">
                    Selected: <strong>
                      {planningMode === 'pantry' ? 'Plan from My Pantry' : 'I Will Create My Own Plan'}
                    </strong>
                  </div>
                )}
                ...
                <div className="mp-plan-summary-box">
                  ...
                  <ul>
                    ...
                    <li><strong>Budget:</strong> {budget ? budget.charAt(0).toUpperCase() + budget.slice(1) : ''}</li>
                    {allergies.length > 0 && (
