...
const MealFeature = () => {
  ...
  const [isCardClicked, setIsCardClicked] = useState(false); // new state
  ...
  const nextSlide = () => {
    if (currentSlide < totalSlides) {
      ...
      // Reset card click state when moving to next slide
  ...
  return (
    <div className="meal-planner-app">
      <div className="meal-planner-wrapper">
        {/* Slide 1 Welcome Screen - same as before */}
        {currentSlide === 1 && (
          <>
        ...
        <div className={`mp-slide-container ${currentSlide === 1 ? 'first-slide' : ''}`}>
          ...
          {/* Slide 1 to 7 same as before - I'm copying them quickly, but they remain unchanged */}
          {/* Slide 1: Welcome */}
          {currentSlide === 1 && (
          ...
          {/* Slide 8: AI Plan Generation - Card click se button dikhe, button click se generate */}
          {currentSlide === 8 && (
            <div className="mp-slide">
              <div className="mp-slide-content">
